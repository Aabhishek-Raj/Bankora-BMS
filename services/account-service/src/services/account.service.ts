...
export class AccountService {
  ...
  create = async ({ userId, accountName = SAVINGS_ACCOUNT, accountType = AccountType.SAVINGS }: AccountCreateDto) => {
  ...
  findByAccountNumber = async (accountNumber: string, userId?: number) => {
  ...
  updateBalance = async (accountNumber: string, type: TransactionType, amount: number) => {
