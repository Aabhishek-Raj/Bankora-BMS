import { TRANSACTION_TOPICS, TransactionEventData } from '@bankora/constants'
import { BaseProducer } from '@bankora/kafka-client'
...
export const publishTransactionEvent = async <T extends TransactionEventData>(eventData: T): Promise<void> => {
